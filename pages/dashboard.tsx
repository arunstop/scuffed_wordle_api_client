...
export default function Dashboard() {
  ...
  return (
    ...
    <main
      ...
      // data-theme={uiState.darkTheme == false ? "corporate" : "business"}
    >
      <Head>
      ...
      <button className="btn btn-error" onClick={() => countAction.decrease(1)}>
        Decrease
      </button>
      ...
      {/* <div>
        ...
        <button onClick={() => setTheme("corporate")}>Light Mode</button>
        <button onClick={() => setTheme("business")}>Dark Mode</button>
      </div> */}
